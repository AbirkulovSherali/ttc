<article class="col col-game-spacing">
    <article class="subtitle-row">
        ...
        <h3 class="relative-pos-game">
            <span class="points"><span class="nameuser">Игрок: <span class="usermoves moves">3</span></span></span><span class="points"><span class="computer">Компьютер: <span class="computermoves moves">2</span></span></span>
        </h3>
    </article>
    ...
    <article class="container-row center form">
        <article class="form-win">
            ...
            <article class="alert-spacing-error">
                <article class="alert"><span class="underline">Сообщение:</span> Введите своё имя !!</article>
            </article>
        </article>
        <br>
    </article>
    <div class="button-start">
        <a href="index.php?template=1"><button>НОВАЯ ИГРА</button></a>
    </div>
</article>
